 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "* Create a complete interface and exception handling using python along with form validation\n",
   ...
   "outputs": [
    ...
    },
    {
     ...
     "text": [
      ...
      "127.0.0.1 - - [13/Jun/2021 13:09:12] \"GET / HTTP/1.1\" 200 -\n",
      "127.0.0.1 - - [13/Jun/2021 13:09:41] \"GET /aekansh53@gmail.com HTTP/1.1\" 404 -\n",
      "127.0.0.1 - - [13/Jun/2021 13:10:15] \"POST / HTTP/1.1\" 200 -\n",
      "127.0.0.1 - - [13/Jun/2021 13:10:35] \"GET /aekansh53@gmail.com HTTP/1.1\" 404 -\n"
     ]
    }
   ],
   "source": [
